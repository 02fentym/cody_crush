...
### URLS for progress_views.py
    path("course/<int:course_id>/progress/", views.student_progress, name="progress"),
    path("course/<int:course_id>/progress/<int:student_id>/", views.student_progress, name="student-progress"),
